...
def people_tracker(args):
    ...
    while True:
        ...
        if len(my_idx) > 0:
            ...
            for i in my_idx.flatten():
                ...
                for j in range (i+1, len(my_idx.flatten())):
                    distance = 250*euclidian_distance(x,y,boxes[j][0],boxes[j][1])/h
                    if distance < 200:
                        color = (0, 0, 255)
                    elif distance < 350:
                        color = (0,255,0)
        ...
        pts_src = np.array([[606, 106], [806, 132], [511, 434],[201, 354]])
        cv2.circle(frame, (601, 103), 4, (0 ,0, 0), -1)
        cv2.circle(frame, (806, 132), 4, (0 ,0, 0), -1)
        cv2.circle(frame, (511, 434), 4, (0 ,0, 0), -1)
        cv2.circle(frame, (201, 354), 4, (0 ,0, 0), -1)


        cv2.line(frame, (601, 103), (806, 132), (0 ,0, 0), 2)
        cv2.line(frame, (806, 132), (511, 434), (0 ,0, 0), 2)
        cv2.line(frame, (511, 434), (201, 354), (0 ,0, 0), 2)
        cv2.line(frame, (201, 354), (601, 103), (0 ,0, 0), 2)
        
        pts_dst = np.array([[450,120], [550,120], [550,500], [450,500]])
